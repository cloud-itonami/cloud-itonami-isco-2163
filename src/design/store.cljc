(ns design.store
  "SSoT for the ISCO-08 2163 independent product and garment design
  practice actor. Store is a protocol injected into the `design.actor`
  ...
  Domain:
    ...
    record   — a committed design record under a project
               (design concept, material specification, safety concern,
